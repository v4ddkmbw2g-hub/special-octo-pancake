...
2. Tag each question with a California CCSS ELA Reading-Literature standard code appropriate to the grade band, formatted exactly like "CCSS.ELA-LITERACY.RL.5.1". Use the grade number that matches the requested band (K-2 -> RL.1/RL.2, 2-3 -> RL.2/RL.3, 3-5 -> RL.3/RL.4/RL.5, 5-6 -> RL.5/RL.6, 6-8 -> RL.6/RL.7/RL.8, 9-12 -> RL.9-10 and RL.11-12).
